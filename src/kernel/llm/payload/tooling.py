...
class ToolRegistry:
    ...
    def list_all(self) -> list[dict[str, Any]]:
        ...
        return [_to_openai_tool_schema(tool.to_schema()) for tool in self._tools.values()]
...
def _to_openai_tool_schema(schema: dict[str, Any]) -> dict[str, Any]:
    """将简单工具 schema 规范化为 OpenAI function tool 格式。"""
