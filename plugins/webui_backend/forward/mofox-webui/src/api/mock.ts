  ...
  modelStats: {
      ...
      data: {
        stats: {
          'deepseek-ai/DeepSeek-V3.2': {
            total_calls: 128,
            prompt_tokens: 820000,
            completion_tokens: 210000,
            total_tokens: 1030000,
            total_cost: 4.2,
            avg_time: 1.42,
            avg_tokens_per_call: 8046.88,
            tps: 728.87
          },
          'Qwen/Qwen3-8B': {
            total_calls: 264,
            prompt_tokens: 540000,
            completion_tokens: 190000,
            total_tokens: 730000,
            total_cost: 0.0,
            avg_time: 0.88,
            avg_tokens_per_call: 2765.15,
            tps: 829.55
          }
        }
      }
    ...
    overview: {
      ...
      data: {
        total_models: 2,
        total_calls: 392,
        total_tokens: 1760000,
        total_cost: 4.2,
        most_used_model: 'Qwen/Qwen3-8B',
        most_expensive_model: 'deepseek-ai/DeepSeek-V3.2'
      }
    },
    detail: {
      success: true,
      data: {
        ...
        total_cost: 4.2,
        avg_tokens_per_call: 8046.88,
        avg_time_per_call: 1.42,
        tps: 728.87,
        cost_per_ktok: 4.0777
      }
    },
    provider: {
      success: true,
      data: {
        stats: {
          SiliconFlow: {
            total_calls: 392,
            prompt_tokens: 1360000,
            completion_tokens: 400000,
            total_tokens: 1760000,
            total_cost: 4.2,
            avg_time: 1.06,
            avg_tokens_per_call: 4489.8,
            tps: 804.15
          }
        }
      }
    ...
    module: {
      ...
      data: {
        stats: {
          replyer: {
            total_calls: 220,
            prompt_tokens: 690000,
            completion_tokens: 180000,
            total_tokens: 870000,
            total_cost: 2.8,
            avg_time: 1.15,
            avg_tokens_per_call: 3954.55,
            tps: 756.52
          },
          tool_use: {
            total_calls: 172,
      ...
      data: {
        chart_data: {
          ...
          pie_chart_cost_by_module: {
            labels: ['replyer', 'tool_use'],
            data: [2.8, 1.4]
          },
          bar_chart_cost_by_model: {
            labels: ['deepseek-ai/DeepSeek-V3.2', 'Qwen/Qwen3-8B'],
            data: [4.2, 0.0]
          },
          bar_chart_req_by_model: {
            labels: ['Qwen/Qwen3-8B', 'deepseek-ai/DeepSeek-V3.2'],
            data: [264, 128]
          },
