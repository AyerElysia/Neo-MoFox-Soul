...
| `tell_dfc_count` ↑ | 中枢主动唤醒 DFC | 提升 `arousal` |
...
![Figure F6 · SNN 微观结构（8→16→6 LIF 网络）](../figures/F6_snn_structure.svg)

*Figure F6 · SNN 微观结构（8→16→6 LIF 网络）*


![Figure F7 · 软 STDP 与经典 STDP 学习曲线对比](../figures/F7_stdp_curve.svg)
